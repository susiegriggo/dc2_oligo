...
@click.option('--kind', type=click.Choice(['monomer', 'dimer', 'homomer', 'ordinal_homomer']), default='monomer', help='Type of training (monomer, dimer, homomer, or ordinal_homomer)')
